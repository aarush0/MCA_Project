...
class bc_LSTM:
	...
	def __init__(self):
		...
		self.modality = "audio"
		self.PATH = "./data/models/{}_weights_{}.hdf5".format("audio",self.classification_mode.lower())
		self.OUTPUT_PATH = "./data/pickles/{}_{}.pkl".format("audio",self.classification_mode.lower())
